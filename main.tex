...
\newcommand{\thesisVersion}{version 1.1-RC\xspace}
\newcommand{\thesisOrderNumber}{2015ISAL0103\xspace}
...
\input{content/colophon} 			% INCLUDE: Ecole Doctorale page
\cleardoublepage
...
\input{content/greetings} 		% INCLUDE: remerciements
\cleardoublepage
