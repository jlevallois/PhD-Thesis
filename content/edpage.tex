\begin{figure*}[htbp]
    % \centering
    \hspace*{-2cm}
    \includegraphics[trim=0cm 3cm 0cm 0cm, width=1.30\textwidth]{gfx/ED.pdf} %% UGLY HACK because I don't want to rewrite by hand this unaesthetic document : http://www.insa-lyon.fr/sites/www.insa-lyon.fr/files/ecoles-doctorales_2011-2015_maj12102015.pdf
    \includegraphics[height=3cm, width=\textwidth]{images/misc/WhitePixel} %% Removing credits of this file, because it's unlicenced (not core of his thesis, just an inescapable page).
\end{figure*}
...
\begin{entrylist}
  ...
  \entryEmpty
  \entryMerged
    {\textsc{Résumé :} voir page suivante}
  \entryMerged
