...
\RefChapitre{sec:notions}, nous proposons dans le \RefChapitre{sec:estimators}
...
paramètre. Ensuite, dans le \RefChapitre{sec:applications}, nous dérivons ces
...
ces travaux dans le \RefChapitre{sec:conclusion}.
%
%
%
