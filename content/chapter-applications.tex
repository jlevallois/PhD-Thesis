...
l'autre intègre des informations géométriques de l’objet. Nous nous
...
(\RefSection{sec:applications:feature:ridge}), les méthodes basées sur un morceau
...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{@{}lrr@{}}
      ...
      Points d’inflexions de la surface  & $|\vv_{max}|$       & $\vv_{max}/|\vv_{max}|$ \\ \bottomrule
    \end{tabular}
  \end{center}
\end{table}
%
...
\cauthors{Mérigot}{Merigot2011} dans l'état de l'art du
