...
la \RefSection{sec:applications:feature:comparison}.
%
...
de la forme d'entrée. La \RefSection{sec:applications:feature:comparison} compare le résultat de l'\RefEquation{eq:moment-C1} avec deux rayons différents.
%
...
\end{equation}
%
\cauthors{Cuel}{Cuel2014DGCI} ont d'ailleurs défini une variante digitale du
\VCM :
%
\begin{equation}
...
Voting} en anglais) sur des patchs locaux de surface. Ce dernier, défini par
...
régulière discrète}, \cauthors{Park}{Park2012} accumulent dans une matrice les
tenseurs :
%
\begin{equation}
...
\RefSection{sec:applications:feature:II:SOTA}, (voir \RefTable{tab:feature-est})
%
\begin{table}[h]
  \begin{center}
...
comme décrit dans la \RefSection{sec:applications:feature:II:classification},
