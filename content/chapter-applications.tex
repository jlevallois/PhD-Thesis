...
(en jaune)\footnote{$tanh(x)$ est souvent utilisée pour \comJeremy{renforcer des
effets}}.
%
\begin{figure}[ht]{
  \begin{center}
...
\begin{figure}[ht]{
      ...
      \end{center}}
%
      \caption[Analyse en espace-échelle de la courbure en fonction du rayon sur la forme digitale 2D de « Flower »]
...
\begin{definition}
  %
  Pour tout point $x$ sur le bord d'une forme Euclidienne $\Shape$ de $\R^2$
  ...
  \end{equation}
  %
  où $R$ -- le paramètre de l'espace-échelle -- est le rayon de la boule
...
(en noir) au point $x$ pour un rayon de boule $R$ (en orange) et un pas de
...
\begin{property}
  ...
  rayon de la boule et $h$ le pas de discrétisation, pour $x \in \dS$, la
...
cas d'une analyse en espace-échelle) de la boule contrôle la \emph{taille} de
...
digitale de $\FeatDD(R)$) au point $p \in \Boundary{\DigShape}$.
%
\\
%
