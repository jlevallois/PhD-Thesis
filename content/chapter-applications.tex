...
Kinect} apporte un regain d'intérêt pour l'analyse de formes
...
dernieres années est la détection de points caractéristiques. Derrière ce terme
...
intéresserons ici qu'aux singularités.
%
...
d'approches se basent sur des quantités calculées par intégration sur des voisinages
surfaciques de la surface. La caractéristique est déterminée en fonction d'un score
évalué sur la géométrie de voisinages surfaciques centrés autour du point à
considérer. Généralement, les voisinages sont simplement issus d'un noyau sphérique.
...
Dans leurs travaux, \cauthors{Mellado}{Mellado2012} proposent de faire
...
(en jaune)\footnote{$\tanh(\vx)$ est souvent utilisée pour renforcer des
effets}.
...
\paragraph{}
%
La méthode de \nauthors{Park} demande beaucoup (cinq) de paramètres pour être fonctionnelle. De
