...
\newenvironment{proof}{\textit{\textbf{D\'emonstration.\quad}}}{\hfill$\square$\par}
...
\newcommand{\refPrePostShort}[3]{\hyperref[#2]{#1~\ref{#2} page~\pageref{#2}\xspace#3}}
...
\newcommand{\RefChapitreN}[1]{\refPrePostN{chapitre~}{#1}{}}
\newcommand{\RefSectionTable}[1]{\refPrePostShort{\textsection}{#1}{}}
\newcommand{\RefSection}[1]{\refPrePost{paragraphe~}{#1}{}}
\newcommand{\RefSectionN}[1]{\refPrePostN{paragraphe~}{#1}{}}
\newcommand{\RefSections}[2]{\refPrePost{paragraphes~}{#1}{} et \refPrePost{}{#2}{}}
\newcommand{\RefSectionsN}[2]{\refPrePostN{paragraphes~}{#1}{} et \refPrePostN{}{#2}{}}
\newcommand{\RefFig}[1]{\refPrePost{Fig.~}{#1}{}}
\newcommand{\RefFigure}[1]{\refPrePost{figure~}{#1}{}}
\newcommand{\RefFigureN}[1]{\refPrePostN{figure~}{#1}{}}
\newcommand{\RefFigures}[2]{\refPrePost{figures~}{#1}{} et \refPrePost{}{#2}{}}
\newcommand{\RefFigureFake}[2]{figure~#1 de \cite{#2}}
...
\newcommand{\RefTable}[1]{\refPrePost{tableau~}{#1}{}}
\newcommand{\RefTableFake}[2]{tableau~#1 de \cite{#2}}
\newcommand{\RefTablesFake}[3]{tableaux~#1 et #2 de \cite{#3}}
\newcommand{\RefTables}[2]{\refPrePost{tableaux~}{#1}{} et \refPrePost{}{#2}{}}
\newcommand{\RefTablesN}[2]{\refPrePostN{tableaux~}{#1}{} et \refPrePostN{}{#2}{}}
\newcommand{\RefDefinition}[1]{\refPrePost{d\'efinition~}{#1}{}}
\newcommand{\RefDefinitionFake}[2]{d\'efinition~#1 de \cite{#2}}
...
\newcommand{\RefLemmaFake}[2]{lemme~#1 de \cite{#2}}
...
\newcommand{\ComputationalGeometry}{\emph{g\'eom\'etrie computationnelle}\xspace} % /puke
\newcommand{\AlgorithmicGeometry}{\emph{g\'eom\'etrie algorithmique}\xspace}
\newcommand{\DigitalGeometry}{\emph{g\'eom\'etrie digitale}\xspace}
\newcommand{\digitalSnow}{\emph{digitalSnow}\xspace}
...
% cube Q(z)
\newcommand{\Q}[1]{\ensuremath{Q({#1})}}
% h-cube Q_h(z)
\newcommand{\hQ}[2]{\ensuremath{Q_{#2}({#1})}}
...
\newcommand{\AR}{\ensuremath{A(R,\vx)}}
\newcommand{\ARH}{\ensuremath{\hat{A}(R,\vx)}}
...
\newcommand{\Dragon}{\og \textsc{Dragon} \fg{}\xspace}
\newcommand{\Armadillo}{\og \textsc{Armadillo} \fg{}\xspace}
\newcommand{\Lucy}{\og \textsc{Lucy} \fg{}\xspace}
\newcommand{\AsianDragon}{\og \textsc{Asian Dragon} \fg{}\xspace}
