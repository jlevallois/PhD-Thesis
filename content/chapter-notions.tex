...
%
  ...
  dimension 2). En dimension 3, les $2$-cellules sont également nommées les
  \colorize{surfels} (pour \anglais{surface elements}).
%
\end{itemize}
%
...
\colorize{bels} (un \colorize{lignel} en dimension 2, un \colorize{surfel} en dimension
3).
...
Nous pouvons définir les \colorize{surfaces digitales} $\DigBoundary{\DigShape}$
comme étant le bord topologique de l'objet digital. En dimension 2 (\respp
...
Plus concrétement, les surfaces digitales sont des ensembles de bels et de
cellules de dimensions inférieures partageant un côté à l'intérieur de l'objet
et un côté à l'extérieur. La \RefFigure{fig:dig-boundary} illustre (en rouge foncé) le
