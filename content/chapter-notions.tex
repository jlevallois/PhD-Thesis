...
\section{Notations}
%
Le \RefTable{tab:notations} montre la signification des notations utilisées dans
...
de \cauthors{Trier}{Trier1996} pour la reconnaissance de caractères) et la
...
représenter les éléments interpixels \cite{Kovalesvsky1989, Khalimsky1990,
