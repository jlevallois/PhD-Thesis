...
\end{equation}
%
avec $\mu_{\sigma} = 1$ dans le cas général (\todoJeremy{expliciter}). Cette
borne peut être améliorer lorsque la courbure gaussienne n'est pas nulle :
\cauthors{Kraetzel}{Kraetzel1991} obtiennent $\mu_0=\frac{38}{25}-\epsilon$ et \cauthors{Muller}{Muller1999} obtiennent $\mu_0= \frac{66}{43}-\epsilon$.
% %
...
% 318/430 => 0,739534884
%
% (a/2)-1+(1-b*(c-2))/(a+1-2*b*(c-1)) with a=3 and b=1/(2^c-2) and c=4
% (1/2)*(a-1+b*(c-2)-d)-((a-1)/2 +b*(c-1)-d)*((1-b*(c-2))/(a+1-2*b*(c-1))) with a=3 and b=1/(2^c-2) and c=4 and d=4/(2^c)
% (60*s^2-85*s+33)/(120*s+70) with s=3
