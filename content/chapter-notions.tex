...
bord de $\Shape$ est $C^3$-convexe, et le \RefLemmaFake{B.10}{Lachaud2006HDR}
que cette correspondance est continue. La \RefFigure{fig:backproj} nous montre
(en rouge) la projection de tout point $\hat{\vx} \in \partial\Body{\DSh}{h}$
vers des points $\vx \in \dS$. Ainsi, \comJeremy{il existe une correspondance entre les
points des bords $\partial\Body{\DSh}{h}$ et $\dS$ qui ont une distance de
Hausdorff inférieure ou égale à $\frac{\sqrt{2}}{2}h$}. De plus, la projection
