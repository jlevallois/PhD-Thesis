...
(\RefFigure{fig:digitalSnow-curv}, en haut) de
%
...
\begin{figure}[ht]{
    \begin{center}
    \includegraphics[trim={17cm 0 13cm 0},clip,width=6cm]{images/digitalSnow/SnowE2_DigitalData}
    \includegraphics[trim={17cm 0 13cm 0},clip,width=6cm]{images/digitalSnow/SnowI08_DigitalData}\\
    \includegraphics[trim={17cm 0 13cm 0},clip,width=6cm]{images/digitalSnow/snowE2mean_0001}
    \includegraphics[trim={17cm 0 13cm 0},clip,width=6cm]{images/digitalSnow/snowI08mean_0001}\\
    % \includegraphics[trim={17cm 0 13cm 0},clip,width=4.5cm]{images/digitalSnow/snowI08gaussian_0001}\\
    \includegraphics[width=6cm]{images/digitalSnow/Snow_E2bis_II_scale}
    \includegraphics[width=6cm]{images/digitalSnow/Snow_I08_II_scale}\\
    \end{center}}
...
(\RefFigure{fig:digitalSnow-curv}, au milieu) permet tout d'abord de
...
\RefFigure{fig:digitalSnow-curv} en bas montre deux captures de microstructures
...
estimateurs décrits dans le \RefChapitre{sec:estimators}. Ces estimateurs sont
actuellement utilisés et répondent aux attentes des partenaires du projet
\digitalSnow, tout en étant robustes au bruit lié à l'acquisition par le
tomographe à rayons X. Nous avons également proposé l'estimation de singularités
permettant de détecter les facettes des grains de neige (voir le
