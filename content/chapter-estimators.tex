...
dans les
\RefFiguresTF{fig:curv-experiments-ellipse-noise}{fig:curv-experiments-rounded-noise}
...
dimension 2 et 3. Nous avons montré que ces estimateurs convergent
...
vitesses attenduent, et la comparaison avec les autres méthodes rend nos
estimateurs très compétitifs, même en présence de bruit.


Ces estimateurs souffrent par contre de certaines limitations. La première est
qu'ils requièrent de connaitre une approximation volumétrique de la forme
$\Shape$. Nous ne pouvons pas utiliser simplement un approximation du bord de
$\Shape$, comme c'est le cas pour les algorithmes fonctionnant sur les nuages de
points par exemple.
