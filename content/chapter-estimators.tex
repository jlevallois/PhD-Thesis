...
(\cauthors{Pottmann}{Pottmann2007,Pottmann2009}). Cela consiste à déplacer
...
estimateurs digitaux de courbures se basant sur la même idée, nous détaillerons cette approche dans un prochain paragraphe (\RefSection{sec:pottmann-principle}).
%
...
plus à l'ensemble de points. Le meilleur représentant de ces techniques est l'estimation des quantités différentielles par ajustement polynomial des jets osculateurs (\anglais{osculating jets}) de \cauthors{Cazals}{Cazals2005}.
%
\\
%
