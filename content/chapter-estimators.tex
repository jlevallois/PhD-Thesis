...
\anglais{Digital Level Layer} (\DLL). Un \DLL est un sous-ensemble de points
...
méthode est d'assouplir la contrainte d'épaisseur (ce qu'ils appellent le
paramètre de rugosité, voir \RefFigure{fig:dll-roughness, fig:dll-roughness2}). Cela permet
d'approcher des polynomes de degré supérieur à $1$.
%
\begin{figure}[ht]{
    \begin{center}
...
\begin{figure}[ht]{
    ...
    $S$ (en prenant en compte une direction $\vec{d}$, vertical dans notre cas).
...
dans le voisinnage du point $\vx$. Alors l'estimation de la courbure converge
