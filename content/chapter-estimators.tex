...
%
\paragraph{Analyse de segments digitaux maximaux}
%
\MDSS \cite{Coeurjolly2001,deVieilleville2007}
%
\paragraph{Analyse des arcs de cercle digitaux maximaux}
%
...
(voir \RefDefinition{def:digital-circular-arc} pour la définition formelle).

Soit $\Shape$ une forme de compacts
%
\begin{figure}[ht]{
    \begin{center}
    \includegraphics[height=6cm]{images/Notions/MDCA1}
    \end{center}}
...
\end{figure}
% \MDCA \cite{Roussillon2011}
% parameter free
%
\paragraph{Convolutions binomiales}
%
la première basée sur des principes de convolutions binomiales \cite{Malgouyres2008,Esbelin2011} (nous la nommerons \BC par la suite)
%
