...
exemple sont plus rapides, mais très sensibles au bruit comme nous l'avons
montré).
...
avoir des calculs dépendants de la taille du support mais linéaires en la taille de
l'objet. Cependant, cela nécessite d'étudier ces nouveaux noyaux afin de pouvoir
en extraire peut-être des preuves de convergence asymptotique.
...
covariance non pas de la forme elle même mais du cône normal à celle-ci. Ces
approches sont assez complémentaires avec la notre et méritent de s'y intéresser.
