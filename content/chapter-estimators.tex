...
direct (voir \RefFigure{fig:2d-curv-estimator}) : choisir un rayon $R$, centrer
...
plus précise. C'est effet est illustré avec la \RefFigure{fig:2d-area-2}. C'est
...
\begin{definition}
  ...
  \begin{itemize}
    %
    \item $\rho'(\DigShape)$ est le carré de la moyenne des longueurs des segments maximaux pour toutes les coupes $\pi_{\vec{\ve}_i(\vp)} \cap \DigShape$ de $\DigShape$;
    %
...
\RefSection{sec:comparaison-courbure} que nous obtenons des convergence.
%
\begin{definition}
  %
...
\begin{figure}[ht]{
  ...
  choisis l'algorithme de $K$-moyenne avec les rayons de $\CurvHSL$.
  %
...
\begin{figure}[ht]{
  ...
  \end{center}}
  %
  \caption{Répartition du partitionnement du carré des longueurs des segments
...
La \RefFigure{fig:curvature-pfl-map} montre la répartition de ces partitions sur
