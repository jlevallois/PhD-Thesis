...
courbure par intégration volumique de la boule
...
étant la taille de la boule d'intégration) dans la
...
\cauthors{Cuel}{Cuel2014} propose une comparaison complète pour l'estimation des
normales.
%
...
\RefFigure{fig:hough-ball}) de $M$ bins.
...
\RefFigure{fig:Hough_bad}-gauche).
...
\section{Estimation de la courbure par intégration volumique de la boule}
...
\end{proof}
%
\subsection{Analyse digitale de l'intégration volumique de la boule, et
...
utilisé pour guider le rayon de la boule dans preuves des
...
basique calculerait une boule digitale, la centerait sur le bord de l'objet
