...
en chaque point $\vp$ une \emph{mesure de covariance des cellules de Voronoi}
...
\begin{figure}[ht]{
    \begin{center}
    \includegraphics[width=15cm]{images/Notions/MDSS1}
    \end{center}}
...
\cite{Coeurjolly2001}, bien qu'expérimentalement cet estimateur semble bien se
comporter.
...
paramètre. \comJeremy{\MDCA a l'avantage supplémentaire qu'une preuve de convergence
