...
ainsi sans paramètre. De plus, ces longueurs ont permis de définir deux
approches d'estimateurs :

Un approche « globale », \cad que l'ensemble des longueurs des segments maximaux
de la forme nous donnent un rayon global pour la sphère d'intégration. La
...
La plus grosse limitation de ces méthodes sans paramètre est qu'elle est très
dépendante de la qualité de discrétisation de l'objet digital, comme la plupart
