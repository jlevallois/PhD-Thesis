...
\begin{figure}[ht]{
  ...
  \end{center}}
    \caption{Comportement asymptotique (en échelle logarithmique) de $hL^2_D( \DigShape )$.
...
s'inscrivant dans un framework d'évaluation de convergence asymptotique. De
plus, plusieurs estimateurs de courbure de la litérature sont disponible,
...
chapitre, seulement les formes convexes (\Ellipse, \Sphere, \RoundedCube,
\Ellipsoid) respectent les hypothèses des théorèmes de convergence.
%
\begin{table}[ht]
  \centering
  \scriptsize
...
théorèmes~\ref{thm:multigrid-convergence-curv,thm:multigrid-convergence-curv-mean,thm:multigrid-convergence-curv-k1k2,fig:experiments2D-alpha}
étudie les différents alpha + comparaison 2D.
%
\\
%
\begin{figure}[ht]
...
\begin{figure}[ht]
  \begin{center}
    ...
    \begin{tabular}{@{}l c c @{}}
      ...
      Erreur $l_\infty$
    \end{tabular}
    \caption[Évaluation expériementale sur l'objet \Ellipse.]{
      %
...
\begin{figure}[ht]
  \begin{center}
    ...
    \begin{tabular}{@{}l c c @{}}
      ...
      Erreur $l_\infty$
    \end{tabular}
    \caption[Évaluation expériementale sur l'objet \Flower.]{
      %
...
\begin{figure}[ht]
  \begin{center}
    ...
    \begin{tabular}{@{}l c c @{}}
      ...
      Erreur $l_\infty$
    \end{tabular}
    \caption[Évaluation expériementale sur l'objet \AccFlower.]{
      %
