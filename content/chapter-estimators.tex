...
%
  \begin{align}
    \left| \Mom{000}(\Ball{R}{\vx + \mathbf{t}}) - \Mom{000}(\Ball{R}{\vx}) \right|
    & \le O(t R^2), \label{eq-zero-moments-ball-position-error} \\
    \left| \Mom{100}(\Ball{R}{\vx + \mathbf{t}}) - \Mom{100}(\Ball{R}{\vx}) \right|
    & \le O(t R^3) + O( \|\vx\|_\infty t R^2 ), \label{eq-first-moments-ball-position-error}\\
    \left| \Mom{200}(\Ball{R}{\vx + \mathbf{t}}) - \Mom{200}(\Ball{R}{\vx}) \right|
    & \le O(t R^4) + O( \|\vx\|_\infty t R^3 ) + O( \|\vx\|^2_\infty t R^2 ). \label{eq-second-moments-ball-position-error}
  \end{align}
%
  Les autres moments avec le même ordre ont respectivement les mêmes bornes. De
  plus, ces relations restent vraies si $\Ball{R}{\vx+\mathbf{t}}$ ou
