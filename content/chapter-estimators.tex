...
\begin{definition}
  ...
  \end{equation}
  %
  où $\rho(\DigShape) =L_D^2(\DigShape)$ and $A(\DigShape,\vp) =
...
\label{thm:curvature-estimator-2d-pf-conv}
  ...
  $C^3$ et sa courbure bornée non nulle. Soit $\DigShape = \DSh$. Alors, il existe une
...
pour le point $\vp$. Cela a pour conséquence d'avoir une plus grosse boule sur
les parties à faible courbure et de diminuer la taille de la boule sur les zones
fortement courbées.
%
\begin{figure}[ht]{
  \begin{center}
