...
$100$-moment centré est maximisé pour la demi-boule à valeur de $x$ positive
...
%
  ...
  \in \R^3$, pour un radius $R \ge h$, nous avons\footnote{$\mu_i \ge 1$ d'après l'\RefEquation{eq:MomentsByCounting-conv}} :
%
  \begin{equation}
...
%
  ...
  taille de la forme ni de la géométrie. $\|\cdot\|$ est la norme spectrale des
  matrices.
%
\end{theorem}
\begin{proof}
...
%
  ...
  $\DCov{h}( \DigF{\tilde{A}}{h} )$ en sachant que :
  \begin{itemize}
    \item Le rayon $R$ est supérieur à $h$.
    \item $\tilde{A}$ n'est pas vide et est proche de l'origine, nous pouvons alors utiliser les %\RefEquations{}{}.
  \end{itemize}
%
\end{proof}
%
