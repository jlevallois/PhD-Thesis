...
dans la \RefSection{def:principal-curv-estimators}. Afin de pouvoir obtenir des
...
de matrices \cite{Bauer:1960,stewart1990matrix,bhatia1997matrix}.
%
\\
%
...
%
\subsubsection{Estimateurs digitaux sans paramètre de courbure}
%
Dans le \RefSection{sec:segments} nous avons montré les propriétés des segments
maximaux sur les bords d'objets digitaux.
%
\todoInlineJeremy{-------------------------------}
% \todoInlineJeremy{-------------------------------}
% \todoInlineJeremy{-------------------------------}
