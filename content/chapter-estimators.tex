...
courbures principales (\RefSection{sec:ii-3d}) en 3D. Nous adapterons ces
estimateurs à des versions ne nécessitant aucun paramètre (l'unique paramètre
...
\RefSection{sec:comparaison-courbure}. Dans ce chapitre, nous considérons
que $\Shapes = \Shapes^{C}$.
%
...
\section{Estimation de la courbure par intégration volumique d'une boule locale}
